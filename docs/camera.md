...
**Doc type:** Java API + JSON asset format · **Assets:** `Server/Item/Items` · **Verified against 0.5.3**
...
Real shipped example — `Server/Item/Items/_Debug/Test_Camera_Item.json` (the only asset in 0.5.3
...
> in 0.5.3 (the `"Camera"` blocks you'll find in `Server/Models/**` are a *different*, model-camera
