...
- [`docs/blocks-java-api.md`](../../docs/blocks-java-api.md#custom-block-entity-components) — the verified custom block-entity component, item-spawning, and press-F GUI recipe
