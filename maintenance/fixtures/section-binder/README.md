...
Seven defects reintroduced one at a time, each reddening at least one case: both
floors, the two resolve reasons collapsed, the chain never parsed, the heading used
whole, chainless classes bound anyway, and the package-directory check dropped.
